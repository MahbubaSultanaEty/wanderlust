...
const MyBookingPage = async ({ destinations }) => {
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="flex flex-col gap-8">
      ...
      {bookings.map((booking) => (
        <div
          key={booking._id}
          className="group bg-white border border-gray-100 rounded-[36px] overflow-hidden shadow-xl hover:-translate-y-1 transition-all duration-500"
        >
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-4 lg:p-6 flex flex-col justify-between">
              ...
              <div className="flex flex-wrap gap-4 mt-3">
                ...
                <button className="border border-gray-200 hover:bg-gray-100 transition px-4 py-2 rounded-2xl font-semibold text-gray-700 cursor-pointer">
                  Cancel Booking
                </button>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="relative lg:w-[320px] h-[220px] lg:h-auto overflow-hidden">
